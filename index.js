...
const worldCF2014 = fifaData.filter(function(item){
    return item.Year === 2014 && item.Stage === 'Final';
})
console.log('Task 1', worldCF2014);
//(a) Home Team name for 2014 world cup final
  console.log('Task 1a', worldCF2014[0]['Home Team Name'])
//(b) Away Team name for 2014 world cup final
console.log('Task 1b', worldCF2014[0]['Away Team Name'])
//(c) Home Team goals for 2014 world cup final
console.log('Task 1c', worldCF2014[0]['Home Team Goals'])
//(d) Away Team goals for 2014 world cup final
console.log('Task 1d', worldCF2014[0]['Away Team Goals'])
//(e) Winner of 2014 world cup final */
console.log('Task 1e', worldCF2014[0]['Win conditions'])
...
function getAverageGoals(data) {
   const getAverageHomeGoals = data.reduce(function(acc, item){
       return acc + item['Home Team Goals'] + item['Away Team Goals'];
   }, 0)
   return (getAverageHomeGoals / data.length).toFixed(2);
}
